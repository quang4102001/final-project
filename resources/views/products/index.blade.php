                        ...
                        <div class="form-group row gx-3 mb-3">
                            ...
                            <div class="col-md-8">
                                <select class="form-control max-w-[425px]" data-val="true"
                                    data-val-required="The Category field is required." id="SearchCategoryId"
                                    name="SearchCategoryId">
                                    <option value=""
                                        {{ request('SearchCategoryId') == null || request('SearchCategoryId') == '' ? 'selected' : '' }}>
                                        All</option>
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->name }}"
                                            {{ request('SearchCategoryId') == $category->name ? 'selected' : '' }}>
