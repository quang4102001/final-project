<template>
    <div class="w-[250px] fixed top-0 left-0 h-[100vh] bg-[#343a40] text-[1.6rem] shadow-lg" id="main-sidebar">
        <div class="header p-2 border-bottom border-[#4b545c] h-[56px] flex justify-center">
            <img src="https://admin-demo.nopcommerce.com/css/admin/images/logo.png" alt="img-logo" class="h-100" />
        </div>
        <div class="">
            <div class="side-bar-form p-[1rem] relative p-[.5rem]">
                <input class="w-100 leading-[24px] py-[6px] pl-[12px] pr-[30px] border-2 bg-[#343a40] 
                outline-0 rounded focus:bg-white focus:border-[#80bdff] text-[#929292]" type="text"
                    name="search-side-bar" placeholder="Search">
                <span class="material-symbols-outlined text-[#929292] text-[3rem] absolute top-50 right-[10px] transform translate-y-[-50%]">
                    search
                </span>
            </div>
            <nav class="mt-3">
